...
I9 owns exact-release `gramine-sgx` hardware evidence, fresh Processor
collateral, empirical budgets and activation of the V1 public route. A real
Platform node supplies its own collateral at admission.
