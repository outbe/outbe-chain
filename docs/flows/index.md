...
| [PFS-003](003-gratis-pledge-credis-repayment.md) | A Gratis pledge opens a Credis position and the price path resolves it | ADR-B-SMA-001; ADR-S-ORC-001; ADR-C-GRT-001 through ADR-C-GRT-003, ADR-C-FID-001, ADR-C-CRD-001 through ADR-C-CRD-002, ADR-C-VLT-001 | Draft | Partial: in-process open/latch/settle lifecycle; call unarmed pending the daily scan; proof/vault stubs |
