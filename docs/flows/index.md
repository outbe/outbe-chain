...
| [PFS-003](003-gratis-pledge-credis-repayment.md) | A Gratis pledge opens a Credis position and the price path resolves it | ADR-B-SMA-001; ADR-S-ORC-001; ADR-C-GRT-001 through ADR-C-GRT-003, ADR-C-FID-001, ADR-C-CRD-001, ADR-C-VLT-001 | Draft | Partial: in-process lifecycle incl. latch/call/void scan; CCA bond and reward pool absent; vault stubbed |
