...
| [PFS-002](002-off-chain-poc-protocol-flow.md) | Finalized OCOMP job independently executes Lysis and atomically activates Tribute-to-Nod effects | ADR-B-CNS-001, ADR-B-CNS-003, ADR-B-TST-001; ADR-S-OCM-001 through ADR-S-OCM-004; ADR-C-MET-001, ADR-C-LYS-001 | Draft | Implementation present; exact-revision Linux public/E2E closure pending |
| [PFS-003](003-gratis-pledge-credis-repayment.md) | A Gratis pledge opens a Credis position and the price path resolves it | ADR-B-SMA-001; ADR-S-ORC-001; ADR-C-GRT-001 through ADR-C-GRT-003, ADR-C-FID-001, ADR-C-CRD-001 through ADR-C-CRD-002, ADR-C-VLT-001, ADR-S-CYC-001 | Draft | Partial: in-process open/latch/settle/call/void lifecycle armed by the `credis_call_daily` scan; proof/vault stubs |
...
| [PFS-009](009-multichain-auction-day.md) | A worldwide day is auctioned across chains and creators are paid | ADR-S-CYC-001; ADR-C-MET-001, ADR-C-LYS-001, ADR-C-DES-001, ADR-C-INX-001 through ADR-C-INX-007, ADR-C-PRM-003; ADR-B-XCH-001 | Draft | Production-path automation gap for PFS-009-01 through -04; live transport walk manual |
