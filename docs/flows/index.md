...
| [PFS-002](002-off-chain-poc-protocol-flow.md) | Finalized OCOMP job independently executes Lysis and atomically activates Tribute-to-Nod effects | ADR-B-CNS-001, ADR-B-CNS-003, ADR-B-TST-001; ADR-S-OCM-001 through ADR-S-OCM-004; ADR-C-MET-001, ADR-C-LYS-001 | Draft | Target specified; OCOMP implementation absent |
