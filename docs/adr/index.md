...
| S | `OCM` | Off-chain computation lifecycle, evidence and quorum apply |
...
| [ADR-S-VAL-002](system/ADR-S-VAL-002-role-scoped-validator-operational-keys.md) | Role-scoped validator operational keys | validatorset, Oracle ZeroFee, OCOMP system carrier | Accepted |
