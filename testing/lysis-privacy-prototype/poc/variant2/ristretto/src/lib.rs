pub mod crypto;
pub mod edwards_gadget;
pub mod link;
pub mod note_link;
pub mod source_opening;
pub mod state;
pub mod vss;
pub mod wide;
pub mod wire;
...
pub fn bp() -> &'static BulletproofGens {
    ...
    P.get_or_init(|| BulletproofGens::new(32, 128))
}
...
pub fn prove_range(
    ...
    if vs.is_empty() || len > 128 || ![8, 16, 32].contains(&bits) {
