...
export const CONTRACTS: Record<string, ContractEntry> = {
  ...
  oracle: {
    ...
    abi: parseAbi([
      ...STRUCTS,
      "function getExchangeRate(address base, address quote) view returns (uint256 rate, uint64 lastBlock, uint64 lastTimestamp)",
      ...
      "function getPairs() view returns (uint32[] pairIds, address[] bases, address[] quotes, bool[] isActive)",
