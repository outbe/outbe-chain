...
const STRUCTS = [
  ...
  "struct Position { uint256 positionId; address vaultProvider; address asset; address bundleAccount; uint256 totalAnadosisAmount; uint256 outstandingAnadosisAmount; uint256 totalGratisAmount; uint256 outstandingGratisAmount; uint32 nextAnadosisNumber; uint64 createdAt; }",
