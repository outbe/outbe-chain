...
///
/// Registration, updates, getters, and events use canonical EIP-2537 G2 keys
/// (256 bytes): x.c0 || x.c1 || y.c0 || y.c1, each component padded to 64 bytes.
/// Compressed 96-byte inputs and the point at infinity are rejected.
interface IL2Registry {
    ...
    /// Returns the operator and 256-byte EIP-2537 G2 key. Reverts when not registered.
