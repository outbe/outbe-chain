...
interface IIntexFactory {
    ...
    /// @notice A called group the sweep cannot retire; its load stays out of circulation.
    event SeriesExpiryStalled(uint32 indexed worldwideDay, uint16 indexed referenceCurrency);
