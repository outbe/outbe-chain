...
contract ReservationToken {
    ...
    function setFee(bool enabled) external { fee = enabled; }
...
contract ReservationVault {
    ...
    function setRejectDeposits(bool reject) external { rejectDeposits = reject; }
    function previewWithdraw(uint256 amount) external pure returns (uint256) { return amount; }
