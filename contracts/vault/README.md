...
This project is based on https://github.com/morpho-org/vault-v2.
...
Depositors of outbe-vault earn from the underlying markets without having to actively manage their position.
...
An [adapter registry](./src/VaultV2.sol#L89-L97) is used to constrain which adapters a vault can have and add.
