...
import {InvalidExecType, InvalidCallType} from "@zerodev/kernel/types/Error.sol";
...
abstract contract ExecutionManager {
    function _beforeExternalDelegateCall() internal virtual {}
