...
} from "@zerodev/kernel/interfaces/IERC7579Modules.sol";
import {ValidationManager} from "@zerodev/kernel/core/ValidationManager.sol";
import {ExecutorManager} from "@zerodev/kernel/core/ExecutorManager.sol";
import {HookManager} from "@zerodev/kernel/core/HookManager.sol";
import {SelectorManager} from "@zerodev/kernel/core/SelectorManager.sol";
import {ERC1271} from "@zerodev/kernel/lib/ERC1271.sol";
import {
...
} from "@zerodev/kernel/types/Error.sol";
import {ModuleInstalled, ModuleUninstalled} from "@zerodev/kernel/types/Events.sol";
import {Install, EnableModeSignature, ModuleStorage, PermissionSignature} from "@zerodev/kernel/types/Structs.sol";
import {
    ValidationId,
    ValidationMode,
    ValidationType,
...
import {Lib4337} from "@zerodev/kernel/lib/Lib4337.sol";
import {
    getType,
    getValidator,
    getPermissionId,
...
} from "@zerodev/kernel/lib/Utils.sol";
import {
...
abstract contract ModuleManager is ValidationManager, ExecutorManager, HookManager, SelectorManager, ERC1271 {
    function _beforeModuleMutation() internal view virtual {}
