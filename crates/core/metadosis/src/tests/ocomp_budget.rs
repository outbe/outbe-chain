...
#[test]
fn request_budget_split_auctions_the_day_nominal_and_leaves_limit_headroom_unissued() {
    // A day that earned less than the limit auctions the rest of what it earned;
    // the headroom is neither briefed nor carried.
    let weak =
