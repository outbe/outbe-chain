...
//!
//! Owns the persistent EVM storage slots at `ACCOUNTING_PROGRESS_ADDRESS`:
//! schema version at slot 0 and `last_accounted_block_number: u64` at slot 1.
//!
//! ## Scope
//!
//! * [`schema::Accounting`] — versioned storage facade.
...
//! `[0xef]` EIP-161 marker. Only the executor Phase 1 path may write slot 1
