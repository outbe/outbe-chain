...
mod admission;
pub use admission::{ArtifactAdmissionError, ArtifactPlan, ProposalForfeit};
...
impl Mailbox {
    ...
    fn pending_next_epoch_artifact(&self, current_epoch: Epoch) -> Option<DkgBoundaryArtifact> {
