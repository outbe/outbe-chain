...
fn compressed_entities_genesis_binds_schema_and_empty_sealed_catalog_root() {
    ...
    assert_eq!(storage[&slot0], format!("0x{:064x}", 4));
    assert_eq!(
        storage[&slot1],
        format!(
            "{:#066x}",
