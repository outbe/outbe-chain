...
use outbe_primitives::addresses::{
    ...
    GRATIS_ADDRESS, GRATIS_FACTORY_ADDRESS, GRATIS_POOL_ADDRESS, INTEX_ADDRESS,
    ...
    TRIBUTE_ADDRESS, TRIBUTE_FACTORY_ADDRESS, VALIDATOR_SET_ADDRESS, VAULT_PROVIDER_ADDRESS,
