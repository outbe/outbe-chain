...
use outbe_primitives::addresses::{
    ...
    GRATIS_FACTORY_ADDRESS, INTEX_ADDRESS, INTEX_FACTORY_ADDRESS, METADOSIS_ADDRESS, NOD_ADDRESS,
    NOD_FACTORY_ADDRESS, ORACLE_ADDRESS, OUTBE_SYSTEM_TX_ADDRESS, PROMIS_ADDRESS,
    PROMIS_FACTORY_ADDRESS, PROMIS_LIMIT_ADDRESS, REWARDS_ADDRESS, SLASH_INDICATOR_ADDRESS,
    STAKING_ADDRESS, TEE_REGISTRY_ADDRESS, TRIBUTE_ADDRESS, TRIBUTE_FACTORY_ADDRESS,
    VALIDATOR_SET_ADDRESS, VAULT_PROVIDER_ADDRESS, ZEROFEE_ADDRESS, ZKPROOF_GROTH16_ADDRESS,
