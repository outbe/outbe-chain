...
//!
//! Every runnable chain must carry this field. Production selects
//! `DcapRequired`; a development network selects `GramineDirectDev` in a
//! different chain ID/genesis. Both use OST3, and neither can fall back at
//! runtime.
