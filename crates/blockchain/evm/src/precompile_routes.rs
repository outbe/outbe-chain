...
define_exact_routes! {
    ...
    CCA_REGISTRY_ADDRESS => (DispatchAdapter::Basic(outbe_ccaregistry::precompile::dispatch), default_base_gas, ValuePolicy::Payable, outbe_ccaregistry::precompile::PAYABLE_SELECTORS),
